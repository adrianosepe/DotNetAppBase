...
// ReSharper restore LoopCanBeConvertedToQuery
            ...
            {
                return GetGenericArguments(type).FirstOrDefault();
            }

            public static Type GetGenericArgumentOnTop(Type type)
            {
            ...
            public static bool IsSubType(Type baseType, Type implementation)
            {
                return implementation.IsSubclassOf(baseType);
            }
            ...
            public static bool SupportNull(Type type)
            {
