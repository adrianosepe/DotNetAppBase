...
using Grapp.AppBase.Std.Library.ComponentModel.Attributes.ViewDesign;
...
namespace Grapp.AppBase.Std.Library.ComponentModel.Types
{
    ...
    public class XTypeDescriptor : IXTypeDescriptor
	{
		...
		public bool IsPropertyRequired(PropertyDescriptor propertyDescriptor)
		{
			return BehaviorIdentifier.IsPropertyRequired(propertyDescriptor);
		}
