...
using Grapp.AppBase.Std.Library.ComponentModel.Model.Validation.Annotations;
using Grapp.AppBase.Std.Library.ComponentModel.Model.Validation.Annotations.Key;
...
namespace Grapp.AppBase.Std.Library.ComponentModel.Model.Validation.Behaviors
{
	public static class BehaviorIdentifier
	{
		...
		{
			public static bool Is(PropertyInfo propertyInfo)
			{
			    return Is(propertyInfo, out _);
			}
			...
			public static bool TryGetNavigationProperty(Type modelType, PropertyInfo fkPropertyInfo, out PropertyInfo navPropertyInfo, Type navPropertyType = null)
			{
				...
				if(!Is(fkPropertyInfo, out navPropertyName))
				{
					navPropertyInfo = null;
			...
			{
				string navPropertyName;
				if(!Is(fkPropertyDescriptor, out navPropertyName))
				{
					navPropertyInfo = null;
