...
namespace Grapp.AppBase.Std.Library.ComponentModel.Model.Validation
{
    ...
    public static class ValidationDataFormats
    {
        ...
        public static bool AllowNullOrEmpty(string input, Func<string, bool> validation)
        {
            return String.IsNullOrEmpty(input?.Trim()) || validation(input);
        }
        ...
        public static bool VeirifcaValidadePis(string pis)
        {
            try
            {
                ...
                for(var i = 0; i < 10; i++)
                {
                    sum += Int32.Parse(pis[i].ToString()) * multiplicador[i];
                }
        ...
        public static bool VerificaValidadeCnpj(string cnpj)
        {
            try
            {
                ...
                for(var i = 0; i < 12; i++)
                {
                    soma += Int32.Parse(value[i].ToString()) * multiplicador1[i];
                }
                ...
                for(var i = 0; i < 13; i++)
                {
                    soma += Int32.Parse(value[i].ToString()) * multiplicador2[i];
                }
        ...
        private static bool VeirifcaValidadeCpf(string cpf)
        {
            try
            {
                ...
                for(var i = 0; i < 9; i++)
                {
                    sum += Int32.Parse(value[i].ToString()) * multiplicador1[i];
                }
                ...
                for(var i = 0; i < 10; i++)
                {
                    sum += Int32.Parse(value[i].ToString()) * multiplicador2[i];
                }
