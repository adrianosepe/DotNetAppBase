...
using Grapp.AppBase.Std.Library.ComponentModel.Types;
...
namespace Grapp.AppBase.Std.Library.ComponentModel.Model.Validation
{
	public class EntityValidationHelper<TEntity>
	{
		...
		public EntityValidationHelper<TEntity> AddValidationsResult(EntityValidationResult entityValidationResult)
		{
			return AddValidationsResult(entityValidationResult.Validations);
		}
