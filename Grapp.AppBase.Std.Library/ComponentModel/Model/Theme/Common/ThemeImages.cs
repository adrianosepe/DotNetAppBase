...
namespace Grapp.AppBase.Std.Library.ComponentModel.Model.Theme.Common
{
	public static class ThemeImages
	{
		...
		public static class Arrange
		{
			...
			public const string WithTextWrapping_BottomCenter = "Dev/Arrange/WithTextWrapping_BottomCenter";
			public const string WithTextWrapping_BottomLeft = "Dev/Arrange/WithTextWrapping_BottomLeft";
			public const string WithTextWrapping_BottomRight = "Dev/Arrange/WithTextWrapping_BottomRight";
			public const string WithTextWrapping_CenterCenter = "Dev/Arrange/WithTextWrapping_CenterCenter";
			public const string WithTextWrapping_CenterLeft = "Dev/Arrange/WithTextWrapping_CenterLeft";
			public const string WithTextWrapping_CenterRight = "Dev/Arrange/WithTextWrapping_CenterRight";
			public const string WithTextWrapping_TopCenter = "Dev/Arrange/WithTextWrapping_TopCenter";
			public const string WithTextWrapping_TopLeft = "Dev/Arrange/WithTextWrapping_TopLeft";
			public const string WithTextWrapping_TopRight = "Dev/Arrange/WithTextWrapping_TopRight";
		...
		public static class Charts
		{
			...
			public const string DrillDownOnArguments_Chart = "Dev/Chart/DrillDownOnArguments_Chart";
			public const string DrillDownOnArguments_Pie = "Dev/Chart/DrillDownOnArguments_Pie";
			public const string DrillDownOnSeries_Chart = "Dev/Chart/DrillDownOnSeries_Chart";
			public const string DrillDownOnSeries_Pie = "Dev/Chart/DrillDownOnSeries_Pie";
		...
		public static class Filters
		{
			...
			public const string FilterByArgument_Chart = "Dev/Filter/FilterByArgument_Chart";
			public const string FilterByArgument_Pie = "Dev/Filter/FilterByArgument_Pie";
			public const string FilterBySeries_Chart = "Dev/Filter/FilterBySeries_Chart";
			public const string FilterBySeries_Pie = "Dev/Filter/FilterBySeries_Pie";
		...
		public static class Pages
		{
			...
			public const string PaperKind_A3 = "Dev/Pages/PaperKind_A3";
			public const string PaperKind_A4 = "Dev/Pages/PaperKind_A4";
			public const string PaperKind_A5 = "Dev/Pages/PaperKind_A5";
			public const string PaperKind_A6 = "Dev/Pages/PaperKind_A6";
			public const string PaperKind_Executive = "Dev/Pages/PaperKind_Executive";
			public const string PaperKind_Legal = "Dev/Pages/PaperKind_Legal";
			public const string PaperKind_Letter = "Dev/Pages/PaperKind_Letter";
			public const string PaperKind_Tabloid = "Dev/Pages/PaperKind_Tabloid";
		...
		public static class Scheduling
		{
			...
			public const string CellsAutoHeight_ = "Dev/Scheduling/CellsAutoHeight_";
