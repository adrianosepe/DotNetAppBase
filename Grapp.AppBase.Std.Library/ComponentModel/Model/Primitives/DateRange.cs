    ...
    public struct DateRange : IDateRange
    {
        ...
        public override string ToString()
        {
            ...
            if(IsNullPartial)
            {
                if(IsNullMin)
                {
                    return String.Format(DbMessages.DateRange_ToString_maior_ou_igual_a__0_, Max);
                }

                return String.Format(DbMessages.DateRange_ToString_menor_ou_igual_a__0_, Min);
            }
