...
namespace Grapp.AppBase.Std.Library
{
	public partial class XHelper
	{
		public static partial class Async
		{
			...
			{
				doWork = doWork ?? delegate { };
				completeWork = completeWork ?? delegate { };
			...
			public static IAsyncResult BeginInvoke(Action method, TimeSpan? delay = null, TimeSpan? minSpan = null)
			{
				return BeginInvoke((Delegate)method, delay, minSpan);
			}

			public static IAsyncResult BeginInvoke(Delegate method, TimeSpan? delay, TimeSpan? minSpan, params object[] args)
			{
				delay = delay ?? TimeSpan.Zero;
				minSpan = minSpan ?? TimeSpan.Zero;
