...
namespace Grapp.AppBase.Std.Library
{
	public partial class XHelper
	{
		...
		{
			public const string DefDisplay_AGerar = "[A Gerar]";
			public const string DefDisplay_NaoInformado = "[Não Informado]";
			public const string DefDisplay_Indisponivel = "[Indisponível]";
