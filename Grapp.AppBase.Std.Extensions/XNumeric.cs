...
// ReSharper restore CheckNamespace
{
	...
	public static decimal AsMoney(this decimal value) => XHelper.Data.Numeric.Round(value, decimalPlaces: 2);

    public static string DisplayAsCurrency(this decimal value) => XHelper.DisplayFormat.Financial.AsCurrency(value);

    public static string DisplayAsCurrency(this double value) => XHelper.DisplayFormat.Financial.AsCurrency(value: (decimal)value);

    public static string FormatAsCurrency(this decimal value) => XHelper.DisplayFormat.Financial.Format(value);

    public static string FormatAsCurrency(this double value) => XHelper.DisplayFormat.Financial.Format(value: (decimal)value);
