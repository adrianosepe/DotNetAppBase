...
// ReSharper restore CheckNamespace
{
    ...
    {
        return row.Get(field, defaultValue: default(T));
    }
    ...
    {
        return row.GetBoolean(field, defaultValue: false);
    }
    ...
    {
        return row.GetDecimal(field, defaultValue: 0);
    }
    ...
    {
        return row.GetInt32(field, defaultValue: 0);
    }
    ...
    {
        return row.GetInt64(field, defaultValue: 0);
    }
    ...
    {
        return row.GetString(field, defaultValue: null);
    }
    ...
    {
        return row.GetType(field, defaultValue: null);
    }
    ...
    {
        return row.GetTypeInstance(field, defaultValue: null);
    }
    ...
    {
        return row.GetTypeInstance(field, defaultValue: null) as T;
    }
    ...
    {
        var instance = row.GetTypeInstance(field, defaultValue: null) as T;
