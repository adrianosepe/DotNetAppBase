...
// ReSharper restore CheckNamespace
{
	...
	{
		return reader.Get(field, defaultValue: default(T));
	}
	...
	{
		return new DateTimeOffset(dateTime: reader.GetDateTime(field), TimeSpan.Zero);
	}
	...
	{
		return reader.GetDecimal(field, defaultValue: 0);
	}
	...
	public static int IndexOf(this IDataRecord @this, string name)
	{
		...
		{
			if(String.Compare(strA: @this.GetName(i), name, StringComparison.OrdinalIgnoreCase) == 0)
			{
				return i;
			}
		}
