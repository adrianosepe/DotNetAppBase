...
namespace DotNetAppBase.Std.Library.ComponentModel.Model.Validation.Annotations
{
	public class XRegexAttribute : XValidationAttribute
	{
		...
		public XRegexAttribute(Regex regex, string errorMessage = null, EDataType dataType = EDataType.Custom) : base(dataType, EValidationMode.MaskRegEx, errorMessage) => _regex = regex;
